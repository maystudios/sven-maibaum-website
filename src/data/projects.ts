...
export const projectCards: ProjectCard[] = [
  ...
  },
  {
    ...
    filters: ["unreal-engine"],
    dataTags: ["unreal-engine", "platformer", "puzzle", "indie"],
  ...
  },
  {
    ...
    title: "Mobile Games",
    summary:
      "Veröffentlichte Mobile-Puzzles und laufende Spieleprojekte: Shapes, Tiles und HydroLoop.",
    tags: [
      { label: "Google Play", className: "tech-tag tech-tag-green" },
      { label: "Puzzle Games", className: "tech-tag tech-tag-teal" },
      { label: "Android / iOS", className: "tech-tag tech-tag-blue" },
    ],
    filters: [],
    dataTags: ["mobile-games", "android", "ios", "puzzle", "app-release"],
    image: `${import.meta.env.BASE_URL}assets/projects/mobile-games/card.svg`,
    route: "/projekte/mobile-games",
